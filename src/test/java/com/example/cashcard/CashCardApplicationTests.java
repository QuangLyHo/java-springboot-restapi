...
@Sql("/com/example/cashcard/data.sql")
class CashCardApplicationTests {
    ...
    @Test
    void shouldReturnASortedPageOfCashCardsWithNoParamsAndUseDefaultValues() {
        ResponseEntity<String> response = restTemplate
            .withBasicAuth("sarah1", "abc123")
            .getForEntity("/cashcards", String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    ...
    @Test
    void shouldNotReturnWhenUsingBadCredentials() {
        ResponseEntity<String> response = restTemplate
    ...
    @Test
    void shouldNotAllowAccessToCashCardsTheyDontOwn() {
        ResponseEntity<String> response = restTemplate
            .withBasicAuth("sarah1", "abc123")
    ...
    void shouldNotUpdateACashCardThatDoesNotExist() {
        ...
        ResponseEntity<Void> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .exchange("/cashcards/9999", HttpMethod.PUT, request, 
                    Void.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }
